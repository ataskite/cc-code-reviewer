...
OUTPUT="$(bash "$ROOT_DIR/scripts/core/detect-project.sh" "$LOCAL_PROJECT")"
...
if bash "$ROOT_DIR/scripts/core/detect-project.sh" "$TMP_DIR/missing" >"$MISSING_OUTPUT" 2>&1; then
