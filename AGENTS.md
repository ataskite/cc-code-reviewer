...
This is a **claudecode plugin skill** for enterprise-grade Java code review. It provides 15-dimension comprehensive analysis with 4 review modes (fast/standard/deep/security), supporting both incremental and stock review types.
...
Main Skill (skills/cc-code-reviewer/SKILL.md)
    ...
    ↓
Sub Agent (agents/cc-code-reviewer.md)
